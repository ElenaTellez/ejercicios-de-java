...
<html>
    ...
    <body>
        ...
        <%
           ...
           int columnaCaballo = letras.indexOf((request.getParameter("coordenadas")).substring(0, 1)) + 1;
           int filaCaballo = Integer.parseInt((request.getParameter("coordenadas")).substring(1, 2));
          ...
          for(fila = 8; fila > 0; fila--) {
               ...
               for (columna = 1; columna < 9; columna++) {
                   ...
                   if ((columnaCaballo == columna) && (filaCaballo == fila))
                           out.print("<img src=\"caballo_negro.png\"> </td>");
                       else
                           out.print(" </td>"); 
                }
