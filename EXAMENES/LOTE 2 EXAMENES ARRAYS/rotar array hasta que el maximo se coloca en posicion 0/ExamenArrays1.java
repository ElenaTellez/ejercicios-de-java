...
public class ExamenArrays1 {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < 10; i++){
          ...
          if (numeros[i] > valor){ //Compruebo si es el mayor
              mayor = i; //La posición en el array del mayor
              valor = numeros[i]; //El numero mayor
          }
        
    }
      
    if (mayor!=0){ //Si es 0 no hay que dar ninguna vuelta porque ya está en su sitio
           
        for (int o = 10 - mayor; o > 0; o--){ //Se calcula el número de posiciones que hay que saltar
