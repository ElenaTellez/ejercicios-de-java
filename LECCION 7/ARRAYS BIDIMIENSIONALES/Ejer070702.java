 ...
 * 
 * Ojo: ejercicio importante. comparar con el de Arroyo que lo hace de otra forma
 * 
 * @author Elena Téllez
 */
public class Ejer070702 {
    ...
    do {
      ...
      switch(cuadrante[x][y]) {
        case VACIO:
          ...
          if ((Math.abs(x - minaX) < 2) && (Math.abs(y - minaY) < 2)) { // calcula el valor absoluto, es decir, x-minax y minax - x. 
            System.out.println("Cuidado, hay una mina cerca.");   // El valor absoluto libera al numero del signo negativo tambien. 
          }
          break;
        case MINA:
